...
mainFrame.Draggable = false -- Vamos usar nosso próprio sistema de drag
...
-- Cantos arredondados do frame principal
...
-- Função para criar toggles melhorados
...
-- Função para criar dropdowns melhorados
...
local function getClosestTarget()
    -- Verificar se ainda estamos no jogo
...
-- Conexões para gerenciar cleanup
local connections = {}
...
-- Detectar quando a GUI for destruída
...
connections[#connections + 1] = RunService.RenderStepped:Connect(function()
    -- Verificar se ainda estamos no jogo e a GUI existe
    ...
    if shouldAim then
        ...
        if target and camera and camera.Parent then
            ...
            if success and fovStroke and fovStroke.Parent then
                -- Efeito visual no círculo FOV quando mirando
...
-- Cleanup quando o LocalScript for destruído
...
-- Cleanup adicional para quando o jogador deixa o jogo
